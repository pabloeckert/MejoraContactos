...
## Commits desde el handoff anterior (handoff-2026-08-12_2041)

```
43cba03 wip: snapshot antes de handoff (2026-08-12_2257)
```

### Archivos modificados

```
 config.yaml                         |   7 ++  handoffs/handoff-2026-08-12_2041.md | 201 ++++++++++++++++++++++++++++++++++++  src/motor/config.py                 |   7 ++  src/motor/dedup/merge_engine.py     |   8 ++  src/motor/llm_judge.py              |  14 ++-  tests/test_llm_judge.py             |  21 ++++  6 files changed, 254 insertions(+), 4 deletions(-)
```
