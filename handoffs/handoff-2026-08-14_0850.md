...
## Commits desde el handoff anterior (handoff-2026-08-13_2054)

```
99c2717 wip: snapshot antes de handoff (2026-08-14_0850)
```

### Archivos modificados

```
 DECISIONES.md                       |  51 ++++  TUTORIAL.md                         |  17 ++  handoffs/handoff-2026-08-13_2054.md | 431 +++++++++++++++++++++++++++++++++  src/motor/api.py                    |   7 +-  tests/test_api.py                   |  18 ++  ui/src/components/ContactsTable.tsx | 463 ++++++++++++++++++++++++++++++------  ui/src/types.ts                     |   2 +  7 files changed, 917 insertions(+), 72 deletions(-)
```
